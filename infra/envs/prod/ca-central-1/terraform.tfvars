settings = {
  ...
  environment      = "prod"
  region           = "ca-central-1"
  domain_name      = "ca-central-1.prod.example.com"
  ...
  database_subnet_cidrs = ["10.100.20.0/24", "10.100.21.0/24", "10.100.22.0/24"]
  ...
  ssm_parameters = {
    ...
    "clients/example-client/status" = {
      description = "Example non-sensitive client onboarding marker."
      value       = "enabled"
    }
  }
