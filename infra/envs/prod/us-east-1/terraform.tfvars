settings = {
  ...
  environment      = "prod"
  region           = "us-east-1"
  domain_name      = "us-east-1.prod.example.com"
  hosted_zone_name = "example.com"

  vpc_cidr              = "10.110.0.0/16"
  azs                   = ["us-east-1a", "us-east-1b", "us-east-1c"]
  public_subnet_cidrs   = ["10.110.0.0/24", "10.110.1.0/24", "10.110.2.0/24"]
  private_subnet_cidrs  = ["10.110.10.0/24", "10.110.11.0/24", "10.110.12.0/24"]
  database_subnet_cidrs = ["10.110.20.0/24", "10.110.21.0/24", "10.110.22.0/24"]
