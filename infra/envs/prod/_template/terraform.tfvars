settings = {
  ...
  domain_name      = "PLACEHOLDER-REGION.prod.example.com"
  hosted_zone_name = "example.com"

  vpc_cidr              = "10.PLACEHOLDER.0.0/16"
  azs                   = ["PLACEHOLDER-REGIONa", "PLACEHOLDER-REGIONb", "PLACEHOLDER-REGIONc"]
  public_subnet_cidrs   = ["10.PLACEHOLDER.0.0/24", "10.PLACEHOLDER.1.0/24", "10.PLACEHOLDER.2.0/24"]
  private_subnet_cidrs  = ["10.PLACEHOLDER.10.0/24", "10.PLACEHOLDER.11.0/24", "10.PLACEHOLDER.12.0/24"]
  database_subnet_cidrs = ["10.PLACEHOLDER.20.0/24", "10.PLACEHOLDER.21.0/24", "10.PLACEHOLDER.22.0/24"]
